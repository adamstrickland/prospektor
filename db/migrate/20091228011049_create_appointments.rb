class CreateAppointments < ActiveRecord::Migration
  def self.up
    ...
    execute 'CREATE VIEW Appointments ( AppointmentID,ContactID,CB Date,CB Time,CB Sale Probability,Comments,ApptStatus,Entered,Closes Attempted,Call First,RepID,Teleconference,Pre-Appointment,e-mailsent,Lettersent,Cooperative,References Requested,Maintain Contact,Online Meeting,TimeStart,TimeEnd,NoSaleReason,Problem1,Impact1,Problem2,Impact2,Problem3,Impact3,Probable ACS Date,Probable Sale Date,SSMA_TimeStamp) AS SELECT id,contact_id,cb_date,cb_time,cb_sale_probability,comments,appt_status,entered,closes_attempted,call_first,rep_id,teleconference,pre_appointment,e_mailsent,lettersent,cooperative,references_requested,maintain_contact,online_meeting,time_start,time_end,no_sale_reason,problem1,impact1,problem2,impact2,problem3,impact3,probable_acs_date,probable_sale_date,created_at FROM appointments'
  end

  def self.down
    execute 'DROP VIEW Appointments'
